...
const nh = CL(Math.max(s.fedHeat + hc - heatDecay - passiveDecay, heatFloor), 0, 100);
...
// STYLES
// ═══════════════════════════════════════════════════════════════
const ft = “‘Orbitron’,‘Courier New’,monospace”;
const ftBody = “‘Courier New’,monospace”;
...
return <span style={{ color: “#fff”, fontSize: size, fontFamily: “‘Orbitron’,sans-serif”, fontWeight: 700, textShadow: glow, animation: anim, letterSpacing: 1, WebkitTextStrokeWidth: “0.5px”, WebkitTextStrokeColor: color, …style }}>{children}</span>;
});
...
<div style={{ fontSize: 20, fontWeight: 900, color: “#1a1a1a”, fontFamily: “‘Georgia’,serif”, letterSpacing: 1, marginBottom: 2 }}>The Miami Herald</div>
<div style={{ width: “100%”, height: 2, background: “#1a1a1a”, marginBottom: 3 }} />
<div style={{ width: “100%”, height: 1, background: “#1a1a1a”, marginBottom: 8 }} />
<div style={{ fontSize: 8, color: “#888”, fontFamily: “‘Georgia’,serif”, marginBottom: 10 }}>METRO/DADE EDITION · DAY {dayNum}</div>
<span style={{ fontSize: 40, display: “block”, marginBottom: 8 }}>{newspaper.icon}</span>
<div style={{ fontSize: 17, fontWeight: 900, color: “#111”, lineHeight: 1.3, margin: “0 0 8px”, fontFamily: “‘Georgia’,serif” }}>{newspaper.headline}</div>
<div style={{ width: 40, height: 1, background: “#ccc”, margin: “0 auto 10px” }} />
<div style={{ fontSize: 12, color: “#333”, lineHeight: 1.7, fontFamily: “‘Georgia’,serif” }}>{newspaper.sub}</div>
